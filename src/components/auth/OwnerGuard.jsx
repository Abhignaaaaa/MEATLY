...
export default function OwnerGuard({ children, onNavigateToLogin, onNavigateToHome }) {
    ...
    return (
      <div className="min-h-screen bg-[#F7F8EF] flex flex-col items-center justify-center p-4">
        <div className="bg-white rounded-[24px] border border-[#E4E4DA] p-6 max-w-sm w-full text-center space-y-4 shadow-sm">
          ...
          <h2 className="text-xl font-bold text-[#20231B]">Access Denied</h2>
          <p className="text-sm text-[#6F7268]">This area is restricted to shop owners only.</p>
